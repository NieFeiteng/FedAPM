...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Plot test accuracy for a dataset and seed.')
    ...
    plt.legend()
    plt.grid(True)
    plot_file = os.path.join(result_dir, f"{dataset_name}_test_acc_seed_{seed_value}.png")
