...
python var_para.py --datasets "${datasets[@]}" --data_dir "$DATA_DIR" --result_dir "$RESULT_DIR"
python var_para.py --datasets "${datasets[@]}" --data_dir "$DATA_DIR" --result_dir "$RESULT_DIR"
...
# python generate_training_loss_subplots.py --datasets "$dataset1" "$dataset2" --data_dir "$DATA_DIR" --result_dir "$RESULT_DIR"
