...
def args_parser():
    ...
    parser.add_argument('--framework', type=str, default='FedAvg', choices=['FedAPM', 'FedAvg', 'FedAlt', 'FedSim', 'FedProx'], help="federated learning framework")
    parser.add_argument('--partition', type=str, default='dir-label-skew', choices=['dir-label-skew', 'q-label-skew'], help="type of partitioning data")
    ...
    parser.add_argument('--model', type=str, default='CNN', choices=['CNN', 'ImageTextClassifier', 'HARClassifier', 'MMActionClassifier'], help='model name')
    parser.add_argument('--dataset', type=str, default='cifar10', choices=["cifar10", 'crisis_mmd', 'ku_har', 'crema_d'], help="name of dataset")
