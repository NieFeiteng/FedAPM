...
def args_parser():
    ...
    parser.add_argument('--framework', type=str, default='FedADMM', choices=['pFedMe', 'ditto', 'FedAPM', 'FedAvg','lp-proj-2','FLAME-lp-proj-2', 'FedAlt', 'FedSim', 'FedProx', 'FedADMM'], help="federated learning framework")
    ...
    parser.add_argument('--model', type=str, default='CNN', choices=['CNN', 'ImageTextClassifier', 'HARClassifier', 'MMActionClassifier', 'ECGClassifier', 'ResNet18', 'MLP', 'MLR', 'CNN1', 'CNN2'], help='model name')
    parser.add_argument('--dataset', type=str, default='cifar10', choices=["cifar10", 'crisis_mmd', 'uci_har', 'ku_har', 'crema_d', 'cifar100','tinyImageNet','mnist', "fmnist", 'mmnist', 'femnist', 'synthetic'],  help="name of dataset")
    parser.add_argument('--strategy', type=str, default='random', choices=['random', 'full'], help="client selection strategy")
    parser.add_argument('--frac_clients', type=float, default=0.2, help='fraction of clients candidates: S')
    ...
    # if args.dataset in ['hateful_memes', 'crisis_mmd', 'uci_har', 'ku_har', 'crema_d']:
