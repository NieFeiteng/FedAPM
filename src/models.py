...
class FuseBaseSelfAttention(nn.Module):
    ...
    def add_adapters(self, adapter_hidden_dim, dropout):
        self.adapter1 = AdapterBlock1(self.d_hid * self.d_head, adapter_hidden_dim, dropout)
        self.adapter2 = AdapterBlock1(self.d_hid * self.d_head, adapter_hidden_dim, dropout)
